...
- 代表人及董監事的其他公司職務
- 第一頁直接列出「IPO候選：未公發且具規模之優先覆蓋公司」
- 第一頁直接列出「SPO／轉板／再籌資覆蓋：已公開市場公司」
- IPO高（有效資本額5億元以上）、IPO中（1億元以上）及公開市場覆蓋的可稽核篩選規則
- 可篩選並保留來源軌跡的 Excel 研究文件

Skill 會把有股權或控制證據的關係，與僅因代表人／董監事重疊形成的關聯分開，避免將人脈關聯誤列為母子公司。

承銷篩選預設採用當期 GCIS 與四類 MOPS 公司名單。未公發公司以實收資本額優先、登記資本額替代來計算有效資本額；歷史退出、同名未核實及缺乏可比較資本的公司不列入 IPO 優先名單。上市／上櫃公司列入 SPO／再籌資覆蓋，興櫃公司列入轉板覆蓋，公發未上市櫃公司列入掛牌路徑覆蓋。
